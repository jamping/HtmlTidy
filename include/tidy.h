...
TIDY_EXPORT TidyNode TIDY_CALL    tidyNodeRemove( TidyNode tnod );
TIDY_EXPORT TidyNode TIDY_CALL    tidyNodeDiscard( TidyDoc tdoc,TidyNode tnod );
...
** @{
*/
TIDY_EXPORT Bool TIDY_CALL tidyNodeIsElement( TidyNode tnod );
